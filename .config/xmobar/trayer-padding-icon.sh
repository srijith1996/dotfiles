...
# run the trayer process
killall trayer
trayer --edge top --align right --SetDockType true --SetPartialStrut true --expand true --width 3 --monitor 0 --transparent true --alpha 0 --tint 0x282c34 --height 21 &
...
# Icon file name
iconfile="$HOME/.xmonad/xpm/trayer-padding-${width}px.xpm"
